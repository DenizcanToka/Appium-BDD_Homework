...
public class StepImplementation extends BaseTest {
    ...
    @Step("<xpath> xpath elementin oldugu kontrol edilir")
    ...
    @Step({"<xpath> li elementi bulana kadar swipe et"})
    public void scrollWithAction(String  xpath){
            Actions actions = new Actions(appiumDriver);
            actions.moveToElement(appiumDriver.findElement(By.xpath(xpath))).build().perform();

    }

    @Step("<xpath> li elementi random seç ve tıkla")
    public void clickRandomProductByxpath(String xpath) {
        List<MobileElement> elements = appiumDriver.findElements(By.xpath(xpath));
        Random rand = new Random();
